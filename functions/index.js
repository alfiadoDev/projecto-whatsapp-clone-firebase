...
exports.saveLasteMessage = functions.firestore.document('/chats/{chatId}/messages/{messagesId}').onCreate((snap, context)=>{
  ...
  //teste para verificar se esta funcionando so podemos deixar alguns consoles
  ...
  return new Promise((resolve, reject)=>{
    ...
    chatRef.onSnapshot(snapChat=>{
      ...
      let messagesRef = chatRef.collection('messages').doc(messageId).onSnapshot(snapMessage=>{
