...
export class WhatsAppController{
        ...
        Message.getRef(this._contactActive.chatId).orderBy('timeStamp').onSnapshot(docs=>{
            ...
            docs.forEach(doc=>{
                ...
                if(this.el.panelMessagesContainer.querySelector('#_'+data.id) && me){
                    ...
                    msgEl.querySelectorAll('.message-status')[0].innerHTML = message.getStatusViewElement().outerHTML;
                }
    ...
    initEvents(){
        ...
        this.el.btnAttachContact.on('click', e=>{
            this._contactsController = new ContactController(this.el.modalContacts, this._user);
        ...
        this.el.btnFinishMicrophone.on('click', e=>{
            this._microphoneController.on('recorded', (file, metada)=>{
                Message.sendAudio(this._contactActive.chatId, this._user.email, file, metada, this._user.photo);
            });
            this._microphoneController.stopRecorder();
            this.closeRecordMicrophone();
        });
